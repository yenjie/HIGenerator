#ifndef QPythiaHadronizer_h
#define QPythiaHadronizer_h
...
namespace gen
{
  ...
  class QPythiaHadronizer : public BaseHadronizer {
  public:
    QPythiaHadronizer(const edm::ParameterSet &);
    virtual ~QPythiaHadronizer();
