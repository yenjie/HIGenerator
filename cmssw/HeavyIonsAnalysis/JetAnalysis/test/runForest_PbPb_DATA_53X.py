...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring("file:/afs/cern.ch/user/d/dgulhan/workDir/test.root")
                            )
...
process.TFileService = cms.Service("TFileService",
                                   fileName=cms.string("/afs/cern.ch/user/d/dgulhan/workDir/HiForesttest.root"))
