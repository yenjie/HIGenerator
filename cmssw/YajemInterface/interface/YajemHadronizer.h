#ifndef YajemHadronizer_h
#define YajemHadronizer_h
...
namespace gen
{
  ...
  class YajemHadronizer : public BaseHadronizer {
  public:
    YajemHadronizer(const edm::ParameterSet &);
    virtual ~YajemHadronizer();
